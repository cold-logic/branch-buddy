...
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "new" -d 'Create a new branch with a slugified name and set its base'
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "get-base" -d 'Get the base branch for the specified branch (or current branch)'
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "set-base" -d 'Set the base branch for a branch'
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "has-base" -d 'Check if a branch has a base set (exits 0 if true, 1 otherwise)'
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "guess-base" -d 'Guess the base branch for a branch'
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "tree" -d 'Show the branch ancestry tree'
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "install-hooks" -d 'Install git hooks (post-checkout) to automatically track branches'
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "doctor" -d 'Check repository for broken base branch links and optionally fix them'
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "log" -d 'Show focused commit log between branch and base (or stack)'
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "init" -d 'Scaffold a new .branchbuddy.toml configuration file'
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "completions" -d 'Generate shell completion scripts'
complete -c branch-buddy -n "__fish_branch_buddy_using_subcommand help; and not __fish_seen_subcommand_from new get-base set-base has-base guess-base tree install-hooks doctor log init completions help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
